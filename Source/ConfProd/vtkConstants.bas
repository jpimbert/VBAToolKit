...
Public Const VTK_PROJECT_ALREADY_IN_LIST = 7001
Public Const VTK_NO_SUCH_PROJECT = 7002
Public Const VTK_NO_PROJECT_LIST = 7003
Public Const VTK_WRONG_FORMAT = 7004

Public Const VTK_SHEET_NOT_VALID = 8001
Public Const VTK_REFERENCE_ERROR = 8002
